...
def main():
    ...
    settings = Settings(mock_mode=False, search_queries_count=6, max_scout_results=20,
                        ...
                        verifier_model=args.analysis_model or "", context_model=args.analysis_model or "",
                        impact_model=args.analysis_model or "", editor_model=args.analysis_model or "")
    llm = AgentRouterProvider(settings)
    digest = run_pipeline(settings, injected=(llm, ManifestSearch(manifest), WebPages(60)),
